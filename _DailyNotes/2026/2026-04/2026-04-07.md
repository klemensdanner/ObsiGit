...
HandyScreenOn: 0
---
**Aufgabe 2: Jagged Array "plattklopfen" (Flatten) - Der Matrix-Test** Schreibe eine Methode `int[] flatten(int[][] jagged)`. Sie bekommt ein 2D-Array übergeben, das unterschiedlich lange Zeilen haben kann.

- **Der Haken:** Sie soll ein einziges, neues 1D-Array zurückgeben, das alle Zahlen aus dem 2D-Array hintereinander enthält.
