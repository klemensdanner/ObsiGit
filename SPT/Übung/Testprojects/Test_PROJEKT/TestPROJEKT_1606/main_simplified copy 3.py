...
try:
    ...
    BACKWARD_SPEED     = -140   # Deutlich spürbares Rückwärtstempo (mm/s)
    BACKWARD_TURN_RATE = 200   # Moderate Drehrate für eine schöne Kurve (deg/s)
    BACKWARD_TIME      = 220   # Dauer der Ausweichkurve in Millisekunden
