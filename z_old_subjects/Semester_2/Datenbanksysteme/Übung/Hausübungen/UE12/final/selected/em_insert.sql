...
INSERT INTO Anstellung (VOName, MANr, FID)
    VALUES ('Concert Hall', 3, 1);
INSERT INTO Anstellung (VOName, MANr, FID)
    VALUES ('Opera House', 3, 1);
INSERT INTO Anstellung (VOName, MANr, FID)
    VALUES ('Open Air Arena', 3, 1);
INSERT INTO Anstellung (VOName, MANr, FID)
...
INSERT INTO MerchandiseArtikel (MName, Hersteller, Preis, Beschreibung, VID)
    VALUES ('little-poster', 'MyMark', 15.50, 'little game boy poster', 7);
INSERT INTO MerchandiseArtikel (MName, Hersteller, Preis, Beschreibung, VID)
    VALUES ('psycho-cup', 'HisMark', 10.00, 'Psycho branded cup', 5);
INSERT INTO MerchandiseArtikel (MName, Hersteller, Preis, Beschreibung, VID)
...
INSERT INTO verkauft_in (MName, Hersteller, VOName, Lagerstand)
    VALUES ('little-poster', 'MyMark', 'Metro Kino', 50);
INSERT INTO verkauft_in (MName, Hersteller, VOName, Lagerstand)
    VALUES ('psycho-cup', 'HisMark', 'Metro Kino', 30);
INSERT INTO verkauft_in (MName, Hersteller, VOName, Lagerstand)
...
INSERT INTO enthaelt (BNr, MName, Hersteller, Stuekzahl)
    VALUES (2, 'little-poster', 'MyMark', 2);
INSERT INTO enthaelt (BNr, MName, Hersteller, Stuekzahl)
    VALUES (3, 'psycho-cup', 'HisMark', 1);
INSERT INTO enthaelt (BNr, MName, Hersteller, Stuekzahl)
