...
CREATE TABLE Funktion(
    FID NUMBER(3),
    Funktionsbezeichnung VARCHAR(50),
...
CREATE TABLE Premiumkunde(
    ...
    --corrected: Telefonnummern als VARCHAR
    Telefon VARCHAR(20),
...
--corrected: zusammengesetzter FK auf Saal
