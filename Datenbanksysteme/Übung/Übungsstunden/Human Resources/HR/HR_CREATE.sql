REM create all tables and other database objects
REM ********************************************************************
...
CREATE TABLE countries 
   ...
   ORGANIZATION INDEX; 
REM ORGANIZATION INDEX erzeugt eine indexorganisierte Tabelle, in der
REM alle Daten (Spalten) einer Tabelle in einem Index gespeichert sind.
REM Ein normaler Index speichert nur die indizierten Spalten, w�hrend
REM eine indexorganisierte Tabelle s�mtliche Spalten im Index ablegt.
REM Generell eignen sich indexorganisierte Tabellen am besten, wenn der
REM Prim�rschl�ssel einen Gro�teil der Spalten in einer Tabelle ausmacht.
...
Rem  e.g. INSERT INTO locations VALUES ( locations_seq.nextval, ... 
...
rem
rem  job-grades table added by p.quick
rem
