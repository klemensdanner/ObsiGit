...
REM ********* constraint dept_mgr_fk not enabled
REM ********* because manager_id from departments 
REM ********* contains 145 and 121 which are not 
REM ********* keys in table employees
Prompt ****** CONSTRAINT dept_mgr_fk NOT ENABLED *******
REM ********* ALTER TABLE departments
REM ********* ENABLE CONSTRAINT dept_mgr_fk;
REM ********* ORA-02298: (DEPT_MGR_FK) kann nicht validiert werden - 
REM ********* übergeordnete Schlüssel nicht gefunden
REM ********* Update manager_id in table departments to guarantee referential integrity
UPDATE DEPARTMENTS SET MANAGER_ID = 149 WHERE DEPARTMENT_ID=80;
UPDATE DEPARTMENTS SET MANAGER_ID = 124 WHERE DEPARTMENT_ID=50;
REM ********* Enable constraint to check referential integrity
ALTER TABLE DEPARTMENTS ENABLE CONSTRAINT DEPT_MGR_FK;
REM ********* There should be no referential integrity violations
/
